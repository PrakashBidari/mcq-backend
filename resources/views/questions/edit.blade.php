    ...
    <div class="max-w-4xl">
        ...
        <div class="rounded-lg bg-white shadow-sm">
            <div class="border-b border-gray-200 p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">Update question information</p>
            </div>

            <form action="{{ route('questions.update', $question->id) }}" method="POST" class="space-y-6 p-6">
                @csrf
                @method('PUT')

                <!-- Question Sets (Searchable Multi-Select) -->
                <div x-data="{
                    selectedSets: {{ json_encode(old('question_sets', $question->questionSets->pluck('id')->toArray())) }},
                    searchQuery: '',
                    isOpen: false
                }">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="position" id="position"
                            value="{{ old('position', $question->position) }}" min="1" max="60"
                ...
                <div>
                    ...
                    <select name="correct_answer" id="correct_answer" required
                        ...
                        @for ($i = 0; $i < 4; $i++)
                            <option value="{{ $i }}"
                                {{ old('correct_answer', $question->correct_answer) == $i ? 'selected' : '' }}>
                                Option {{ chr(65 + $i) }}
                            </option>
                        @endfor
                    </select>
