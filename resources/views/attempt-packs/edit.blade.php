...
@section('title', 'Edit Attempt Pack')
@section('page-title', 'Edit Attempt Pack')
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-xl font-bold text-gray-800">Edit Attempt Pack</h3>
            </div>

            <form action="{{ route('attempt-packs.update', $attemptPack->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')

                <div>
                    <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Name <span class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name', $attemptPack->name) }}" required
                ...
                <div>
                    ...
                    <code class="block px-4 py-3 bg-gray-100 rounded-lg text-sm">{{ $attemptPack->product_key }}</code>
                ...
                <div>
                    ...
                    <input type="number" name="attempts_count" id="attempts_count" value="{{ old('attempts_count', $attemptPack->attempts_count) }}" required min="1"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price', $attemptPack->price) }}" required min="0.01" step="0.01"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $attemptPack->sort_order) }}" min="0"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                ...
                <div>
                    <label class="flex cursor-pointer items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $attemptPack->is_active) ? 'checked' : '' }}
                ...
                <div class="flex items-center gap-3 pt-6 border-t border-gray-200">
                    <button type="submit" class="px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition">Update Attempt Pack</button>
